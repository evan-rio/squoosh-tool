...
export default async function ({ watch }) {
  ...
  return {
    ...
    plugins: [
      ...
      clientBundlePlugin(
        {
          ...
          plugins: [
            ...
            commonjs(),
            resolve(),
            replace({ __PRERENDER__: false, __PRODUCTION__: isProduction, __DESKTOP__: isDesktop }),
            entryDataPlugin(),
      ...
      nodeExternalPlugin(),
      featurePlugin(),
      replace({ __PRERENDER__: true, __PRODUCTION__: isProduction, __DESKTOP__: isDesktop }),
      initialCssPlugin(),
