                ...
                {!lossless && (
                  <div>
                    ...
                    <label class={style.optionTextFirst}>
                      ...
                      >
                        <option value={AVIFTune.auto}>{t('avif.tuning.auto')}</option>
                        <option value={AVIFTune.psnr}>{t('avif.tuning.psnr')}</option>
                        <option value={AVIFTune.ssim}>{t('avif.tuning.ssim')}</option>
                      </Select>
                    </label>
                  </div>
                )}
