            ...
            <div>
              ...
              <div class={style.optionOneCell}>
                <Range
                  ...
                  onInput={this.onChange}
                >
                  {t('webp.alphaFilterQuality')}
                </Range>
              </div>
              <label class={style.optionToggle}>
                {t('webp.autoAdjustFilterStrength')}
                <Checkbox
                  name="autofilter"
              ...
              <div class={style.optionOneCell}>
                <Range
                  ...
                  onInput={this.onChange}
                >
                  {t('webp.filterSharpness')}
                </Range>
              </div>
              <label class={style.optionToggle}>
                {t('webp.sharpRgbToYuv')}
                <Checkbox
                  name="use_sharp_yuv"
              ...
              <label class={style.optionTextFirst}>
                ...
                <Select
                  ...
                  onChange={this.onChange}
                >
                  <option value="0">{t('webp.preprocess.none')}</option>
                  <option value="1">{t('webp.preprocess.segmentSmooth')}</option>
                  <option value="2">
                    {t('webp.preprocess.pseudoRandomDithering')}
                  </option>
                </Select>
              </label>
              <div class={style.optionOneCell}>
  ...
  render({ options }: Props) {
    ...
    return (
      <form class={style.optionsSection} onSubmit={preventDefault}>
        ...
        <label class={style.optionToggle}>
          {t('webp.preserveTransparentData')}
          <Checkbox
            name="exact"
