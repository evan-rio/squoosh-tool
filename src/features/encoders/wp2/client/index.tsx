        ...
        <Expander>
          {!lossless && (
            <div>
              ...
              <label class={style.optionToggle}>
                {t('encoder.separateAlphaQuality')}
                <Checkbox
                ...
                {showAdvanced && (
                  <div>
                    ...
                    <div class={style.optionOneCell}>
                      ...
                      >
                        {t('wp2.errorDiffusion')}
                      </Range>
                    </div>
                    <label class={style.optionTextFirst}>
                      {t('encoder.subsampleChroma')}
                      <Select
                        value={uvMode}
                        onInput={this._inputChange('uvMode', 'number')}
                      >
                        <option value={UVMode.UVModeAuto}>
                          {t('wp2.subsampleChroma.auto')}
                        </option>
                        <option value={UVMode.UVModeAdapt}>
                          {t('wp2.subsampleChroma.vary')}
                        </option>
                        <option value={UVMode.UVMode420}>
                          {t('wp2.subsampleChroma.half')}
                        </option>
                        <option value={UVMode.UVMode444}>
                          {t('wp2.subsampleChroma.off')}
                        </option>
                      </Select>
                    </label>
                    <label class={style.optionTextFirst}>
                      ...
                      >
                        <option value={Csp.kYCoCg}>
                          {t('wp2.colorspace.ycocg')}
                        </option>
                        <option value={Csp.kYCbCr}>
                          {t('wp2.colorspace.ycbcr')}
                        </option>
                        <option value={Csp.kYIQ}>
                          {t('wp2.colorspace.yiq')}
                        </option>
                      </Select>
                    </label>
                    <label class={style.optionToggle}>
                      {t('wp2.colorspace.randomMatrix')}
                      <Checkbox
